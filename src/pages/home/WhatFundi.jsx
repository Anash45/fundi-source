...
const WhatFundi = () => {
  ...
  return (
    <section className="xl:px-[80px] px-6 pt-20">
            ...
            <Link to={card.link} key={index}>
              ...
              >
                ...
                <div className="sm:pr-4 sm:py-6 flex w-full sm:justify-start items-center justify-between gap-4 sm:group-hover:pl-4 transition-[padding-left] duration-300">
                  ...
                  <span
                    className={`rounded-full sm:border-none border group-hover:border-red-500 transition-border duration-300 sm:w-fit sm:h-fit flex items-center justify-center sm:mt-[-3px] ${small

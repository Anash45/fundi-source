...
const featuresdata = [
  ...
  {
    icons: Icon2,
    title: "Customisable church profile",
    disc: " Showcase your church’s mission, goals, and fundraising initiatives on a personalised profile that engages your community.",
  },
...

  {
    ...
    disc: "QR codes and links that direct members, visitors, and local partners to your church's donation page, making it simple for anyone to support your mission instantly.",
  },
...

  {
    ...
    disc: "Motivate and engage your church community with a gamified ranking system that encourages friendly competition and celebrates top supporters.",
  },
  ...
  },
  {
    ...
    disc: "Eliminate the hassle of tax documentation with automatic receipting for all donations, simplifying year-end processes for supporters and church.",
  },
  {
    icons: Icon12,
    title: "Seamless financial support",
    disc: "Receive 100% of supporter contributions with no hidden fees or deductions, ensuring every dollar goes toward your church’s needs.",
  },
  {
    icons: Icon13,
    title: "Silent auction platform (Silenti)",
    disc: "Access Silenti, an online silent auction feature, allowing your church to host exclusive fundraising events with ease.",
  },
  {
    icons: Icon14,
    title: "Weekly payouts",
    disc: "Enjoy consistent cash flow with weekly deposits, ensuring your church has regular access to 100% of funds raised for essential initiatives.",
  },
  {
    icons: Icon15,
